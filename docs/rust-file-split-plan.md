...
| `crates/core-data/src/lib.rs` | 6369 | Continue extracting USDM collector and row-builder helpers after the timeline-ordering, content/timeline/scheduled-instance, geography/governance, abbreviation, object, JSON table, population-column, value helper, data-dir loader, transform, reference, and test splits. |
