...
| `crates/core-api/src/lib.rs` | 7882 | Continue extracting Open Rules compatibility helpers after the CDISC context, static codelist, operation-field, metadata-support, operation-execution, and metadata-execution helper splits. |
...
1. `core-api/src/lib.rs`: continue extracting small pure helper families into
   ...
   metadata-support, operation-execution, and metadata-execution helper slices
