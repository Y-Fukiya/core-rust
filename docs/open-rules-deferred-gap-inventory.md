...
|---|---:|---|
| `official_oracle_fixture_gap` | 51 | Keep out of the score gate. These official `results.csv` files disagree with the rule or input fixture and should become upstream issue/PR candidates. |
