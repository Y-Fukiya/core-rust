...
fn usdm_tag_references(text: &str) -> Vec<(String, String)> {
...
fn usdm_ref_references(text: &str) -> Vec<String> {
    let mut references = Vec::new();
    let mut search_from = 0;
...
fn parameter_map_reference_invalid(
    reference: &str,
    reference_keys: &HashSet<(String, String, String)>,
) -> bool {
...
fn collect_usdm_id_instance_types(value: &Value) -> HashMap<String, String> {
    let mut values = HashMap::new();
    collect_usdm_id_instance_types_at(value, &mut values);
    values
}

fn collect_usdm_reference_keys(value: &Value) -> HashSet<(String, String, String)> {
